...
class Electron {
 ...
 public:
  ...
  private : TLorentzVector p4;
  Short_t IDbit;
  ULong64_t FiredSingleTrgs, FiredDoubleTrgs, FiredL1Trgs;
  Int_t Charge, ChargeConsistent, ConvVeto, MissHits, EcalDrivenSeed;
  Float_t En, SCEn, EcalEn, ESEnP1, ESEnP2, D0, Dz, SIP, Pt, PtError,
      Eta, Phi, R9, CalibPt, CalibEn, SCEta, SCPhi, SCRawEn, SCEtaWidth, SCPhiWidth,
      HoverE, EoverP, EoverPout, EoverPInv, Brem, dEtaAtVtx, dPhiAtVtx, SigmaIEtaIEtaFull5x5,
      SigmaIPhiIPhiFull5x5, ESEffSigmaRR, PFChIso, PFPhoIso, PFNeuIso, PFPUIso, PFClusEcalIso,
      PFClusHcalIso, IDMVAIso, IDMVANoIso, R9Full5x5, Trkdxy, KFHits, KFChi2, GSFChi2,
      Scale_stat_up, Scale_stat_dn, Scale_syst_up, Scale_syst_dn, Scale_gain_up, Scale_gain_dn,
      Resol_rho_up, Resol_rho_dn, Resol_phi_up, Resol_phi_dn;
  std::vector<Int_t> GSFHits, GSFMissHits, GSFNHitsMax;
  std::vector<Float_t> GSFPt, GSFEta, GSFPhi, GSFCharge, GSFVtxProb, GSFlxyPV, GSFlxyBS, BCEn,
      BCEta, BCPhi, BCS25, BCS15, BCSieie, BCSieip, BCSipip;
};
