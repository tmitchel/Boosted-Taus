...
files = [
    ...
    'DYJetsToLL_M-50_HT-2500toInf', 'DYJetsToLL_M-50_v',
    'ST_t-channel_antitop', 'ST_t-channel_top', 'ST_tW_antitop', 'ST_tW_top',
    'SingleElectron_Run2017B-31Mar2018', 'SingleElectron_Run2017C-31Mar2018', 'SingleElectron_Run2017D-31Mar2018',
    'SingleElectron_Run2017E-31Mar2018', 'SingleElectron_Run2017F-31Mar2018',
    'SingleMuon_Run2017B-31Mar2018', 'SingleMuon_Run2017C-31Mar2018', 'SingleMuon_Run2017D-31Mar2018',
    'SingleMuon_Run2017E-31Mar2018', 'SingleMuon_Run2017F-31Mar2018',
    ...
    'WJetsToLNu_HT-2500ToInf', 'WJetsToLNu_Inc',
    'WW', 'WZ', 'ZZ',
]
...
def main(args):
    ...
    # build list of already-hadded files
    ...
    for fname, ifiles in file_dict.iteritems():
        ...
        # skip output files that have no input files
        if len(ifile) == 0:
